...
import CalendarHeader from '@App/Fum/assets/CalendarHeader.svg'
import Star from '@App/Fum/assets/Star.svg'
import list from '@App/Fum/assets/list.svg'
// import PropTypes from 'prop-types'
const UserHeader = props => {
	const user = getDataSession('local', 'fum_user')
	...
	if (user) {
		return (
			<div className="flex justify-between">
				{!isMobile ? (
					<>
						<Button className="cursor-pointer flex" onClick={() => navigate(ROUTER_FUM.event.favorite)}>
		...
		<div className="flex">
			{isMobile ? (
				...
				<>
					...
					>
						{endpoint === ROUTER_FUM.event.teaser ? (
							...
							<Typography
								...
								onClick={() => navigate(ROUTER_FUM.auth.login)}
							>
								ログイン・会員登録
							</Typography>
						)}
