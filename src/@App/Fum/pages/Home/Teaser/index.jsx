...
import teaser_logo from '@App/Fum/assets/teaser_logo.svg'
import teaser_image4 from '@App/Fum/assets/teaser_image4.svg'
import teaser_image5 from '@App/Fum/assets/teaser_image5.png'
import teaser_mobile_image5 from '@App/Fum/assets/teaser_mobile_image5.png'
import teaser_image6 from '@App/Fum/assets/teaser_image6.png'
import teaser_image7 from '@App/Fum/assets/teaser_image7.png'
import teaser_header from '@App/Fum/assets/teaser_header.png'
import teaser_mobile_header from '@App/Fum/assets/teaser_mobile_header.png'
import Equipment from './components/Equipment'
import Rateplan from './components/Rateplan'
import { ROUTER_FUM } from '@App/Fum/configs/constants'
import Contract from './components/Contract'
import { profileService } from '@App/Fum/services/profileService'
			...
			<Box className="sm:flex h-auto sm:h-[724px] bg-[#FFFFFF] ">
				<Box className="sm:w-[60%] sm:text-center sm:mt-[90px] mt-[57px] lg:px-0 sm:px-[24px] px-16">
					...
					<Box className="text-center sm:mt-72 mt-56 sm:mb-0 mb-32">
						<a href={profile?.role === 'business' ? ROUTER_FUM.event.search : import.meta.env.VITE_CMS_LOGIN_URL} target={profile?.role === 'business' ? "_self"  : "_blank"}>
							<Button
								variant="contained"
								color="primary"
