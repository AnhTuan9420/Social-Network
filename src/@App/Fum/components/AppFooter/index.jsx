...
import logoFooter from '@App/Fum/assets/logoFooter.svg'
import appStore from '@App/Fum/assets/App_Store.svg'
import googlePlay from '@App/Fum/assets/Google_Play.svg'
import { ROUTER_FUM } from '@App/Fum/configs/constants'
import bannerFooter from '@App/Fum/assets/bannerFooter.png'
			...
			<Box className="max-w-[1000px] w-full sm:w-[80%] lg:w-[1000px] mx-auto ">
				...
				<Box className="md:flex flex-none items-center mb-20">
					...
					<Typography
						...
						onClick={() => navigate(ROUTER_FUM.questions)}
					>
						よくある質問
					</Typography>
				</Box>
