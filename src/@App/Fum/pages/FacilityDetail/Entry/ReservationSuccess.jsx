...
import tick from '@App/Fum/assets/tick.png'
...
import { historyService } from '@App/Fum/services/historyService'
				...
				<Box className="sm:mb-[220px] mb-[100px] sm:mt-24 mt-16 px-16 sm:px-0">
					...
					{loadingInvoice ? (
						...
						<a
							...
							href={`${ROUTER_FUM.event.detail}/?facility_id=${historydetail ? historydetail?.facility?.id : invoiceDetail?.facility?.id
								}`}
							target="_blank"
						>
							<Box
					...
					<Box className="text-center sm:mt-56 mt-24">
						<Button
							...
							onClick={() => navigate(ROUTER_FUM.event.history)}
						>
							予約・利用履歴一覧を確認する
						</Button>
						<br />
						...
						<Button
							...
							onClick={() => navigate(ROUTER_FUM.event.event_top)}
						>
							TOPに戻る
						</Button>
					</Box>
