...
import { ROUTER_FUM, TRANSLATE_FUM } from '@App/Fum/configs/constants'
...
const SendOTPToEmail = props => {
	...
	const onSubmit = handleSubmit(async data => {
		try {
			...
			navigate(ROUTER_FUM.auth.register.verification_codes)
		} catch (e) {
			errorMsg(e)
		}
	})
					...
					<Box className="px-12">
						...
						<Box className="text-center">
							<LoadingButton
								...
								// onClick={() => navigate(ROUTER_FUM.auth.register.verification_codes)}
							>
								{t('btn.send_code')}
							</LoadingButton>
						</Box>
