...
import logoMobile from '@App/Fum/assets/logoMobile.svg'
			...
			<AppBar position="sticky" className='bg-[#FFFFFF] shadow-none border-b-1 border-[#E0E0E0]'>
				<Toolbar className='justify-between p-0'>
					<Typography component="div" className='cursor-pointer text-[#BDBDBD]'>
						<img src={isMobile? logoMobile : logoFooter} alt="" className="text-[#E0E0E0] lg:pl-[80px] sm:pl-[40px] pl-16" onClick={() =>  navigate(ROUTER_FUM.event.event_top)} />
					</Typography>
					<UserHeader />
				</Toolbar>
			</AppBar>
