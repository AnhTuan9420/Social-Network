...
import EventContentPage from '@App/Fum/components/Layout/EventContentPage'
...
import { getFumUser } from '@Core/helper/Session'
...
import locationMobile from '@App/Fum/assets/locationMobile.svg'
import access from '@App/Fum/assets/access.svg'
import discount from '@App/Fum/assets/discount.svg'
import fee from '@App/Fum/assets/fee.svg'
import holiday from '@App/Fum/assets/holiday.svg'
import introduction from '@App/Fum/assets/introduction.svg'
import facility_type from '@App/Fum/assets/facility_type.svg'
import option_item from '@App/Fum/assets/option_item.svg'
import seating from '@App/Fum/assets/seating.svg'
import tag from '@App/Fum/assets/tag.svg'
import time from '@App/Fum/assets/time.svg'
import station from '@App/Fum/assets/station.svg'
import iconHistory from '@App/Fum/assets/iconHistory.svg'
import warning from '@App/Fum/assets/warning.svg'
import unlike from '@App/Fum/assets/unlike.svg'
import like from '@App/Fum/assets/like.svg'
import homepage from '@App/Fum/assets/homepage.svg'
// import no_image from '@App/Fum/assets/no_image.webp'
import imagefail from '@App/Fum/assets/imagefail.svg'
									...
									<Box className="w-full sm:w-4/12">
										...
										<Box className="sm:mt-20 w-full lg:w-[280px] sm:w-[180px] mx-auto sm:px-0 px-16">
											...
											<Button
												...
												onClick={() =>
													navigate(ROUTER_FUM.inquiry_for_facility, { state: facilityDetail })
												}
											>
												この施設へ問い合わせる
											</Button>
