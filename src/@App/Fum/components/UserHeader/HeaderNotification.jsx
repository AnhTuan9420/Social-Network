...
import notice from '@App/Fum/assets/notice.svg'
import notify from '@App/Fum/assets/notify.svg'
import clsx from 'clsx'
import { ROUTER_FUM } from '@App/Fum/configs/constants'
import { useNavigate } from 'react-router-dom'
import { TabContext, TabList, TabPanel } from '@mui/lab'
import CloseIcon from '@mui/icons-material/Close'
import { notificationsService } from '@App/Fum/services/notificationService'
...
const HeaderNotification = props => {
	...
	const handleUpdateStatus = item => {
		...
		navigate(`${ROUTER_FUM.detail_notification}/?notification_id=${item?.information_id}`)
	}
											...
											.map((value, i) => (
												<Box key={i}>
													<Box
														...
														onClick={() =>
															navigate(
																`${ROUTER_FUM.detail_notification}/?notification_id=${value?.information_id}`
															) & setOpen(false)
														}
													>
														<Box className="pl-[20px] py-16 w-full">
