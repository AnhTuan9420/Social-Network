...
import homeBG from '@App/Fum/assets/homeBG.png'
import logo from '@App/Fum/assets/logoHomePage.svg'
import logoMobile from '@App/Fum/assets/logoHomePageMobile.svg'
...
import { ShowLoginDialog } from '@App/Fum/components/LoginDialog'
import InforHome from './components/InforHome'
import book1 from '@App/Fum/assets/book1.png'
import book2 from '@App/Fum/assets/book2.png'
import book3 from '@App/Fum/assets/book3.png'
import arrow from '@App/Fum/assets/arrow.png'
import arrowMobile from '@App/Fum/assets/arrowMobile.png'
import imageBottom from '@App/Fum/assets/imageBottom.png'
import imageBottomMobile from '@App/Fum/assets/imageBottomMobile.png'
		...
		<Box className="w-full">
			...
			<Box className="text-center sm:px-0 px-16">
				<Button
					...
					type="submit"
					onClick={() => navigate(ROUTER_FUM.event.search)}
				>
					施設を探す
				</Button>
			</Box>
					...
					>
						<Box className="text-center pt-24 px-16">
							<Button
								...
								type="submit"
								onClick={() => navigate(ROUTER_FUM.event.teaser)}
							>
								施設を掲載したい方はこちら
							</Button>
						</Box>
				...
				>
					...
					<Box className="text-center sm:px-0 px-16">
						<Button
							...
							className="sm:w-[500px] w-full sm:text-20 text-16 sm:py-12 py-[17px] px-0 sm:leading-[160%] leading-[140%] shadow-none font-semibold text-[#FFFFFF] "
							type="submit"
							onClick={() => window.open(ROUTER_FUM.event.teaser, '_blank')}
