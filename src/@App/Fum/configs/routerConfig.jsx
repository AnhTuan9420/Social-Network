...
export const routerTraveloConfig = [
	{
		path: ROUTER_FUM.event.search,
		element: <LazyEventSearch />,
		breadcrumb: 'イベント検索'
	},
	{
		path: ROUTER_FUM.auth.login,
		element: <LazyLogin />,
		breadcrumb: 'ログイン'
	},
	{
		path: ROUTER_FUM.auth.login_provider,
		element: <LazyLoginProvider />,
	},
	{
		path: ROUTER_FUM.auth.register.send_otp_to_email,
		element: <LazySendOTPToEmail />,
		breadcrumb: 'アカウント登録'
	},
	{
		path: ROUTER_FUM.auth.register.profile,
		element: <LazyRegisterProfile />,
		breadcrumb: '会員登録'
	},
	{
		path: ROUTER_FUM.auth.register.confirm,
		element: <LazyRegisterConfirm />,
		breadcrumb: '登録内容の確認'
	},
	{
		path: ROUTER_FUM.auth.register.verification_codes,
		element: <LazyVerificationCodes />,
		breadcrumb: '認証コード入力'
	},
	{
		path: ROUTER_FUM.auth.register.success,
		element: <LazyRegisterSuccess />,
		breadcrumb: '会員登録完了'
	},
	{
		path: `${ROUTER_FUM.event.detail}`,
		element: <LazyEventDetail />,
		breadcrumb: 'イベント検索'
	},
	{
		path: ROUTER_FUM.event.favorite,
		element: <LazyEventFavorite />,
		breadcrumb: 'お気に入り'
	},
	{
		path: ROUTER_FUM.event.event_top,
		element: <LazyEventTop />
	},
	{
		path: ROUTER_FUM.event.teaser,
		element: <LazyEventTeaser />
	},
	{
		path: ROUTER_FUM.event.history,
		element: <LazyHistoryList />,
		breadcrumb: '利用履歴'
	},
	{
		path: ROUTER_FUM.entry.item_selection,
		element: <LazyItemSelection />,
		breadcrumb: 'オプションアイテム選択'
	},
	{
		path: ROUTER_FUM.entry.enter_information,
