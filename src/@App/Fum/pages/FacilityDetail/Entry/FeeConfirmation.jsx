...
import calendar from '@App/Fum/assets/calendar.svg'
...
import logoHeader from '@App/Fum/assets/logoHeader.png'
...
import location from '@App/Fum/assets/location.svg'
import locationMobile from '@App/Fum/assets/locationMobile.svg'
import { LoadingButton } from '@mui/lab'
import bankName from '@App/Fum/assets/bankName.svg'
import bankNameMobile from '@App/Fum/assets/bankNameMobile.svg'
	...
	const handleSubmit = async () => {
		try {
			...
			if (dataReponse && dataReponse?.id && dataReponse?.code_id) {
				...
				navigate(ROUTER_FUM.entry.reservation_success, { state: dataReponse?.id })
			}
				...
				<Box className="sm:mb-[220px] mb-[100px] sm:mt-24 mt-16 px-16 sm:px-0">
					...
					{loading ? (
						...
						<a
							...
							href={`${ROUTER_FUM.event.detail}/?facility_id=${facilityDetail?.id}`}
							target="_blank"
						>
							<Box
					...
					<Box className="grid grid-cols-1 sm:grid-cols-3 gap-[16px] sm:mt-[56px] mt-24">
						<Button
							...
							onClick={() =>
								navigate(`${ROUTER_FUM.entry.enter_information}/?facility_id=${facilityDetail?.id}`)
							}
						>
							お客様情報入力へ戻る
						</Button>
